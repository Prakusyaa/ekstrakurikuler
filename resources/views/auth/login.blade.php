@section('title', 'Login - EkstrakurikulerKu.id')
...
<x-guest-layout>
        ...
        <div class="container">
            <div class="w-full max-w-md">
                <div class="text-center mb-6 mt-6">
                    <a href="/" class="flex items-center justify-center mt-4">
                        <svg class="h-12 w-12 text-blue-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <g>
                        ...
                        <span class="ml-2 text-2xl font-bold text-gray-900">EkstrakurikulerKu.id</span>
                    </a>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <x-text-input id="email" class="block w-full pl-10" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="Input Email" />
                        </div>
            ...
            <div class="position-absolute bottom-0 start-0 px-6 py-4">
                <a href="{{ route('index') }}" class="btn inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150 w-full justify-center">
